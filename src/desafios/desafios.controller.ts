...
export class DesafiosController {
  ...
  async criarDesafio(@Body() criarDesafioDto: CriarDesafioDto) {
    ...
    // this.logger.log('saida >>>>>>>>', JSON.stringify(jogadores));
    // this.logger.log(
    //   'entrada >>>>>>>>',
    //   JSON.stringify(criarDesafioDto.jogadores),
    //  );
    criarDesafioDto.jogadores.map((jogadorDto) => {
      ...
      this.logger.log(
        'saida ---->>>',
        JSON.stringify(jogadorFilter[0].categoria['_id']),
        'teste',
      );
      //const categoria = JSON.parse(jogadorFilter[0].categoria);
      //this.logger.log('>>>>>>>>ttttttttt  ', categoria._id);
      this.logger.log(
        'criarDesafioDto ----------',
        JSON.stringify(criarDesafioDto.categoria),
      );
      if (jogadorFilter[0].categoria['_id'] != criarDesafioDto.categoria) {
        console.log('sssssssss', jogadorFilter[0].categoria['_id']);
        console.log('rrrrrrrrrrrrr', criarDesafioDto.categoria);
        throw new BadRequestException(
